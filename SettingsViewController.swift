...
class SettingsViewController: UIViewController, UIGestureRecognizerDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    func prepare_cells() {
        ...
        self.key_signature_cell.initialize_cell(height: 310)
...
class TitleCell: SettingsCell {
    ...
    func initialize_cell(height: CGFloat) {
        ...
        self.label_1.toon_label_with(text: "iSynth", color: .white, alignment: 1, weight: 2, size: 35)
...
class KeySignatureCell: SettingsCell {
    ...
    var title_label = UILabel()
    var sublabel = UILabel()
    var key_segment = UISegmentedControl(items: ["A", "B♭", "B", "C", "D♭", "D", "E♭", "E", "F", "G♭", "G", "A♭"])
    ...
    func initialize_cell(height: CGFloat) {
        ...
        self.key_segment.frame = CGRect(x: 10, y: 75, width: self.dark_box.frame.size.width - 20, height: 65)
        ...
        self.sublabel.frame.size.width -= 20
        self.sublabel.frame.origin.x += 10
        self.sublabel.frame.origin.y += 145
        self.sublabel.toon_label_with(text: "A", color: .white, alignment: 2, weight: 2, size: 15)
        self.sublabel.alpha = 0.5
        self.dark_box.addSubview(self.sublabel)
        
        self.scale_mode_segment.frame = CGRect(x: 10, y: 195, width: self.dark_box.frame.size.width - 20, height: 30)
        ...
        self.sublabel2.frame.size.width -= 20
        self.sublabel2.frame.origin.x += 10
        self.sublabel2.frame.origin.y += 230
    ...
    @objc func handle_key_segment(control: UISegmentedControl) {
        ...
        case 1:
            self.settings_controller_link.origin_controller.master_key_signature = 1
            self.settings_controller_link.origin_controller.theory_assign_scale_mode()
            self.settings_controller_link.origin_controller.update_note_labels()
            self.sublabel.text = "B♭"
        case 2:
            self.settings_controller_link.origin_controller.master_key_signature = 2
            self.settings_controller_link.origin_controller.theory_assign_scale_mode()
            self.settings_controller_link.origin_controller.update_note_labels()
            self.sublabel.text = "B"
        case 3:
        ...
        case 4:
            self.settings_controller_link.origin_controller.master_key_signature = 4
            self.settings_controller_link.origin_controller.theory_assign_scale_mode()
            self.settings_controller_link.origin_controller.update_note_labels()
        ...
        case 5:
            ...
            self.sublabel.text = "D"
        case 6:
            self.settings_controller_link.origin_controller.master_key_signature = 6
            self.settings_controller_link.origin_controller.theory_assign_scale_mode()
            self.settings_controller_link.origin_controller.update_note_labels()
            self.sublabel.text = "E♭"
        case 7:
            self.settings_controller_link.origin_controller.master_key_signature = 7
            self.settings_controller_link.origin_controller.theory_assign_scale_mode()
            self.settings_controller_link.origin_controller.update_note_labels()
            self.sublabel.text = "E"
        case 8:
        ...
        case 9:
            self.settings_controller_link.origin_controller.master_key_signature = 9
            self.settings_controller_link.origin_controller.theory_assign_scale_mode()
            self.settings_controller_link.origin_controller.update_note_labels()
            self.sublabel.text = "G♭"
        case 10:
            self.settings_controller_link.origin_controller.master_key_signature = 10
            self.settings_controller_link.origin_controller.theory_assign_scale_mode()
            self.settings_controller_link.origin_controller.update_note_labels()
            self.sublabel.text = "G"
        case 11:
            self.settings_controller_link.origin_controller.master_key_signature = 11
            self.settings_controller_link.origin_controller.theory_assign_scale_mode()
            self.settings_controller_link.origin_controller.update_note_labels()
            self.sublabel.text = "A♭"
        default:
